      ...
      <div className="row mt-0 mt-sm-3 mb-3 py-5">
        <div className="col-md-6 col-md-push-6 col-lg-5 px-4 px-sm-5 mx-0 mx-md-5 mx-lg-0">
          <div className="mb-4">
            <h4 className="title-secondary text-center">
              <span style={{ letterSpacing: 0.9, textTransform: "uppercase" }}>
          ...
          <div className="row mb-3">
            <div className="col-xs-9">
              ...
              <span
                className="mt-2"
                style={{ display: "inline-block", lineHeight: 18 + "px" }}
              >
          ...
          <div className="form-group loginContent">
            ...
            <div className="form-group has-feedback">
              ...
              <input
                ...
                id="inputSuccess2"
              />
              <span className="lt-icon lt-eye lt-medium form-control-feedback" />
            </div>
          </div>
          <div className="text-center pt-4">
            ...
            <div
              id="fb_login"
              className="btn loginBtn loginBtn-facebook fb-div"
              data-analytics="login-facebook-btn"
              role="button"
              tabindex="0"
            >
              <span className="ng-binding loginBtn-text">
                SIGN IN WITH FACEBOOK
              </span>
            </div>
            <div
              id="google_login"
              className="btn loginBtn loginBtn-google m-top-s1 google-div"
              role="button"
              tabindex="0"
            >
              <span className="ng-binding loginBtn-text">
        ...
        <div className="col-md-6 col-md-pull-6 col-lg-5 col-lg-offset-2">
          <span className="visible-md visible-lg">
            <img
              src="https://dummyimage.com/460x735/ccc/fff"
          ...
          <span className="visible-xs visible-sm px-0 mx-0 px-sm-5 mx-sm-4 px-md-5 mx-md-4 mt-5">
            <img
              src="https://dummyimage.com/630x350/ccc/fff"
              className="img-responsive"
              alt=""
            />
          </span>
